...
class Order(models.Model):
    ...
    status = models.CharField(max_length=60, choices=OrderStatus ,default=OrderStatus.PROCCESSING)
...
class OrderItem(models.Model):
    ...
    price = models.DecimalField(max_digits=7,decimal_places=2 ,default=1,blank=False)
